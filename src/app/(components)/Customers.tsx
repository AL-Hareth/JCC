export default function Customers() {
  return (
    <section className="text-white pt-12">
      ...
      >
        <h2
          className="w-full my-2 text-xl font-black leading-tight text-center text-white lg:mt-8"
        >
        ...
        <div
          className="flex flex-1 flex-wrap max-w-4xl mx-auto items-center justify-between text-xl text-white font-bold opacity-75"
        >
